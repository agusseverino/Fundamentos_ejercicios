...
# a estudiar, por la cantidad total de gramos de comida que ingiere.
# El CSSP es la misma división pero considerando solamente lo que voló la vez
# que más voló y lo que comió la vez que más comió. El CSSV es otra vez la misma idea, 
# respecto de la cantidad de veces que voló y comió. Si 
